...
class DataReader {
    ...
    private String completeExcelData[][] = new String[0][];

//    String[][] readExcel(int sheetNumber) throws IOException {
//        String fileName = PropertyFileReader.TESTDATAFILE + "DataSheet.xls";
...
//    }
    ...
    private String[][] readExcel(Sheet sheet) throws IOException {
        int currentRowSize = sheet.getLastRowNum();
        columnSize = sheet.getRow(0).getLastCellNum();
        rowSize += currentRowSize;
        final String excelData[][] = new String[currentRowSize][columnSize];
        Iterator<Row> rowIterator = sheet.rowIterator();
        rowIterator.next(); //skipHeader
